...
def post():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash("The image was not successfully uploaded")
    ...
    return render_template('blog/blog.html', form=form, action="new")
...
def edit(post_id):
    ...
    return render_template('blog/blog.html', form=form, post=post, action="edit")
